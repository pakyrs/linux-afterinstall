...
#Base tools:
sudo apt install -y net-tools gnupg tldr curl wget git lsb-release lsb-base lsb-core htop vim nmap ufw gufw sshuttle tmate screen pwgen dnsutils gdebi neofetch gparted ubuntu-restricted-extras
#openssh
